...
class ActionPackShower: ActionContinuousBase
{
	...
	{
		if ( target && target.GetObject().IsKindOf("DecontaminationShower") && !target.GetObject().IsKindOf("DecontaminationShowerStatic") && !target.GetObject().IsKindOf("DecontaminationShowerUnlimitedStatic"))
		{
