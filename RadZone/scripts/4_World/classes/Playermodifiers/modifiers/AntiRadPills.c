class AntiRadPillsMdfr: ModifierBase
{
	...
	override void Init()
	{
		...
		m_IsPersistent = true;
		m_ID 					= RZModifiers.MDF_RZANTIRADPILLS;
	...
	override void OnActivate(PlayerBase player)
	{
		...
		#ifdef RZDEBUG
		GetRZLogger().LogInfo("player:"+player.GetIdentity().GetName()+"Anti_Rad_Pills Activated");
		#endif
	}
	...
	override void OnDeactivate(PlayerBase player)
	{
		...
		#ifdef RZDEBUG
		GetRZLogger().LogInfo("player:"+player.GetIdentity().GetName()+"Anti_Rad_Pills Deactivated");
		#endif
	}
